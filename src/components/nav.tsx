...
const navigation: any = [
  ...
  {
    name: "Table",
    href: "https://docs.google.com/spreadsheets/d/1rL10u5_-h2ByaZCC4KMY4sXtWnm5N_IouhpfHPKPylk/edit?usp=sharing",
    target: "_blank",
  },
  {
    name: "Analysis",
            ...
            <div className="">
              ...
              <div className="flex flex-row sm:hidden">
                ...
                <div className="grid content-center ml-2">
                  <strong className="text-white">LAPD Arrests 2019</strong>
                </div>
              </div>
